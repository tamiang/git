...
LIB_OBJS += service/commit-graph-job.o
LIB_OBJS += service/fetch-job.o
LIB_OBJS += service/jobs.o
LIB_OBJS += service/loose-objects-job.o
LIB_OBJS += service/multi-pack-index-job.o
LIB_OBJS += setup.o
