...
static int maintenance_task_fetch(void)
{
	int result = 0;
...
static int pack_files_auto_condition(void)
{
	struct packed_git *p;
	int enabled;
	...
	git_config_get_int("maintenance.pack-files.auto",
...
static int maintenance_task_pack_files(void)
{
	if (multi_pack_index_write()) {
